...
- `js/game/game-factories.js`: criacao do estado inicial, geracao de dados e preload das imagens das cartas.
...
- `js/ui/draw-primitives.js`: primitivas de desenho reutilizaveis para HUD, tiles, cartas, botoes e dados.
- `js/ui/renderer.js`: montagem visual da cena completa e loop de renderizacao.
- `js/ui/input.js`: eventos do mouse, drag and drop dos dados e cliques em botoes/tabuleiro.

## Arquivos de Apoio

- `README.md`: resumo rapido do projeto e da estrutura.
- `docs/game-rules.md`: placeholder para as regras do jogo que voce vai preencher depois.
